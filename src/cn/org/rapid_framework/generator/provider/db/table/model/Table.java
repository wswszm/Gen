...
public class Table {
	...
	public static void main(String[] args) {
		String table = "el_uc_gmfdmfd";
		String[] strs = table.split("_");
		if(strs.length>1)
		{
			table = table.substring(table.indexOf(strs[1].trim()));
		}
	...
	public String getClassName() {
	    ...
	    if(StringHelper.isBlank(className)) {
	    	String table = sqlName;
	  /*  	String[] strs = table.split("_");
			if(strs.length>1)
			{
				table = table.substring(table.indexOf(strs[1].trim()));
			}*/
	        String removedPrefixSqlName = removeTableSqlNamePrefix(table);
